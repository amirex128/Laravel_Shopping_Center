                        ...
                        <form name="form" method="post" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input type="email" name="email"
                                       ...
                                       placeholder="لطفا ایمیل خود را وارد نمایید..." required autofocus value="{{old("email")}}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                <input type="password" name="password"
                                       ...
                                       placeholder="پسورد خود را وارد نمایید..." required>
                            ...
                            <div class="mb-3">
                                <label class="md-check">
                                    <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}><i
                                            class="primary"></i> مرا به خاطر بسپار
                                </label>
                            </div>
                            <button type="submit" class="btn btn-fw primary">ورود</button>
                        </form>
                        @if (Route::has('password.request'))

                            <div class="my-4">
                                <a href="{{ route('password.request') }}" class="text-primary _600">رمز خود را فراموش
                                    کرده اید؟</a>
                            </div>
                        @Endif
                        <div>
                            هنوز ثبت نام نکردی ؟
                            <a href="{{ route('register') }}" class="text-primary _600">ثبت نام</a>
                        </div>
                    </div>
                </div>
            </div>
