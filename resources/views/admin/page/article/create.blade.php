                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route("admin.article.store")}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" class="form-control" placeholder="عنوان مقاله را وارد نمایید ...">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="formGroupInputLarge">توضیحات مختصر</label>
                                <div class="col-sm-10">
                                    <input class="form-control form-control-lg" name="description" type="text" id="formGroupInputLarge" placeholder="خلاصه مقاله را وارد نمایید ...">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="body" placeholder="متن مقاله را وارد نمایید ..." name="content" id="editor"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">انتخاب تصویر شاخص</label>
                                <div class="col-sm-10">
                                    <div class="form-file">
