...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this._elemInput.addClass('form-control ');
        ...
        this._elemArrowBtn = $('<button hidden id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn"><span class="comboTreeArrowBtnImg">▼</span></button>');
